      ...
      <div className="flex flex-wrap -m-2">
        <div className="p-2 w-1/2">
          <div className="relative">
            ...
            <input type="text" id="name" name="name" className="w-full  border border-black bg-white focus:bg-opacity-50 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
        </div>
        <div className="p-2 w-1/2">
          <div className="relative">
        ...
        <div className="p-2 w-full">
          <div className="relative">
            ...
            <textarea id="message" name="message" className="w-full  border border-black bg-white focus:bg-opacity-50 text-base outline-none  h-32  text-black py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
          </div>
        </div>
        <div className="mt-5 max-w-md mx-auto hidden md:flex justify-center items-center md:mt-8">
                <a className="inline-flex items-center font-ibm justify-center h-12 px-6 font-semibold py-3 -transparent text-white bg-black hover:bg-gray">
                  Send
                </a>
        ...
        <div className="p-2 w-full pt-8 mt-8 -t text-center">
          <a className="text-gray">example@email.com</a>
