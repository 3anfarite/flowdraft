...
const CourseSecForm = () => {
   ...
   const handleSave = async () => {
      ...
      try {
        const response = await axios.post('/api/validate-course-sec', newData);
   ...
   return (
      <>
         <div className="px-6 my-24 py-12 md:px-12 bg-gray-50 text-black text-center lg:text-left">
            ...
            <div class="mb-6">
               <label for="base-input" className="block mb-2 text-sm font-medium text-black ">Edit Course Section Title</label>
            ...
            <div className="mb-6">
               <label for="large-input" className="block mb-2 text-sm font-medium text-black ">Edit Course Section Paragraph</label>
