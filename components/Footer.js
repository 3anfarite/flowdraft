  ...
  return (
    <>
      <footer className="p-4 bg-black shadow md:px-6 md:py-8 dark:bg-gray-900">
        ...
        <span className="block text-sm font-ibm text-white sm:text-center dark:text-gray-400">©<a href="#" className="hover:underline">Afterwork Workfkow™</a>. All Rights Reserved.
        </span>
      </footer>
