        ...
        <main className="mt-10">
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-12">
            ...
            <div className="px-4 lg:px-0 mt-12 text-black text-lg leading-relaxed w-full lg:w-3/4">
              ...
              <div className="border-l-4 border-black pl-4 mb-6 italic rounded">
              ...
              <h2 className="text-2xl text-black font-semibold mb-4 mt-4">Uneasy barton seeing remark happen his has</h2>
          ...
          <div className="p-4 border-t border-b md:border md:rounded">
            <div className="flex py-2">
              ...
              <div>
                <p className="font-semibold text-black text-sm"> Mike Sullivan </p>
                <p className="font-semibold text-black text-xs"> Editor </p>
              </div>
            </div>
            ...
            <button className="px-2 py-1 text-black bg-green-700 flex w-full items-center justify-center rounded">
              Follow 
