...
const TestCard = () => {
   return (
      ...
      <div className="absolute hidden md:block -left-10 -bottom-16 w-40 md:w-60 lg:w-64 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-40 items-center bg-cgrey rounded-lg shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] md:max-w-xl">
