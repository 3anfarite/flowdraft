    ...
    <header className="bg-cgrey px-2 sm:px-4 py-2.5 dark:bg-gray-900 sticky w-full z-20 top-0 left-0  dark:border-gray-600">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className='flex md:order-2' >
          ...
          <Link href='/contact' >
            <button type="button" className="text-cgrey bg-black hover:bg-blue-800  focus:ring-blue-300 font-semibold font-ibm text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:bg-gray">Contact Me</button>
          </Link>
